      ...
      <div className="form-container d-flex justify-content-center align-items-center">
        ...
        >
          ...
          <div className="form-button d-grid mt-4 text-center">
            <button
              ...
              style={{
                ...
                transition: "background-color 1s ease, color 2s ease", // Hiệu ứng chuyển đổi màu
              }}
              onMouseOver={(e) => {
                e.target.style.backgroundColor = "#66FF33";
                e.target.style.color = "#fff"; // Thay đổi màu chữ khi hover
              }}
              onMouseOut={(e) => {
                e.target.style.backgroundColor = "#CCFBF0";
                e.target.style.color = "#000"; // Reset màu chữ khi hết hover
              }}
            >
              Login
            </button>
          ...
          <div className="d-flex align-items-center mt-4">
            <div
              style={{ flex: 1, backgroundColor: "#DDE1DF", height: "2px" }}
            />
