...
const HomeCustomer = () => {
  const handleValuation = async () => {
    try {
      const response = await axios.post("/api/valuate", {
        carat,
        color,
        clarity,
      });
      ...
      <Container id="info" className="my-5">
        <div className="d-flex">
          ...
          <div className="w-50 p-2">
            <img
              src="https://res.cloudinary.com/dz2dv8lk4/image/upload/fl_preserve_transparency/v1719877241/cc_evuvjz.jpg?_s=public-apps"
              alt="Diamond"
